...
# Add packages to build and run kik Social
...
sudo -u postgres createdb -U postgres kiksocial_development
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # access the development site at http://kiksocial.local.
  # If you change it, also change it in .env.vagrant before provisioning
  # the vagrant server to update the development build.
  #
  # To install:
  #   $ vagrant plugin install vagrant-hostsupdater
  config.vm.hostname = "kiksocial.local"
