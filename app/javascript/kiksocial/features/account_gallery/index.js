...
} from 'kiksocial/actions/accounts';
import { expandAccountMediaTimeline } from '../../actions/timelines';
import LoadingIndicator from 'kiksocial/components/loading_indicator';
import Column from '../ui/components/column';
import ImmutablePureComponent from 'react-immutable-pure-component';
import { getAccountGallery } from 'kiksocial/selectors';
import MediaItem from './components/media_item';
import LoadMore from 'kiksocial/components/load_more';
import MissingIndicator from 'kiksocial/components/missing_indicator';
import { openModal } from 'kiksocial/actions/modal';
          ...
          <div className='account__section-headline'>
            <div style={{width: '100%', display: 'flex'}}>
              <NavLink exact to={`/${accountUsername}`}>
                <FormattedMessage id='account.posts' defaultMessage='kiks' />
              </NavLink>
              <NavLink exact to={`/${accountUsername}/with_replies`}>
                <FormattedMessage id='account.posts_with_replies' defaultMessage='kiks and replies' />
              </NavLink>
