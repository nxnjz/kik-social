...
require 'thor'
require_relative 'kiksocial/media_cli'
require_relative 'kiksocial/emoji_cli'
require_relative 'kiksocial/accounts_cli'
require_relative 'kiksocial/feeds_cli'
require_relative 'kiksocial/search_cli'
require_relative 'kiksocial/settings_cli'
require_relative 'kiksocial/statuses_cli'
require_relative 'kiksocial/domains_cli'
...
module KikSocial
  class CLI < Thor
    ...
    long_desc <<~LONG_DESC
      ...
      running a kik Social server, as it leaves next to no cache behind on
      other servers.
