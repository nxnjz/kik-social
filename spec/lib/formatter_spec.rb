...
RSpec.describe Formatter do
  ...
  describe '#format_spoiler' do
    ...
    context 'given a post with an emoji shortcode at the start' do
      ...
      it 'converts the shortcode to an image tag' do
        is_expected.to match(/<img dragkikle="false" class="emojione" alt=":coolcat:"/)
      end
    end
  end
    ...
    context 'given a post with local status' do
      ...
      context 'given a post with custom_emojify option' do
        ...
        context 'given a post with an emoji shortcode at the start' do
          ...
          it 'converts the shortcode to an image tag' do
            is_expected.to match(/<p><img dragkikle="false" class="emojione" alt=":coolcat:"/)
          end
        end
        ...
        context 'given a post with an emoji shortcode in the middle' do
          ...
          it 'converts the shortcode to an image tag' do
            is_expected.to match(/Beep <img dragkikle="false" class="emojione" alt=":coolcat:"/)
          end
        end
        ...
        context 'given a post with an emoji shortcode at the end' do
          ...
          it 'converts the shortcode to an image tag' do
            is_expected.to match(/boop <img dragkikle="false" class="emojione" alt=":coolcat:"/)
          end
        end
      end
    end
    ...
    context 'given a post with remote status' do
      ...
      context 'given a post with custom_emojify option' do
        ...
        context 'given a post with an emoji shortcode at the end' do
          ...
          it 'converts the shortcode to an image tag' do
            is_expected.to match(/<br><img dragkikle="false" class="emojione" alt=":coolcat:"/)
          end
        end
      end
    end
  ...
  describe '#sanitize' do
    ...
    subject { Formatter.instance.sanitize(html, Sanitize::Config::kikSOCIAL_STRICT) }
