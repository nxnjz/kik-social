...
describe LanguageDetector do
  ...
  describe 'detect' do
    ...
    let(:account_remote) { Fabricate(:account, domain: 'kik.com') }

    it 'detects english language for basic strings' do
      strings = [
        "Hello and welcome to kik Social how are you today?",
        "I'd rather not!",
    ...
    it 'detects spanish language' do
      string = 'Obtener un Hola y bienvenidos a kik Social. Obtener un Hola y bienvenidos a kik Social. Obtener un Hola y bienvenidos a kik Social. Obtener un Hola y bienvenidos a kik Social'
      result = described_class.instance.detect(string, account_without_user_locale)
