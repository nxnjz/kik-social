// kik Social Stream API
// Copyright (C) 2019 kik AI, Inc.
// License: AGPL-3.0
...
const startWorker = (workerId) => {
  ...
  const pgConfigs = {
    development: {
      ...
      database: process.env.DB_NAME || 'kiksocial_development',
    ...
    production: {
      user:     process.env.DB_USER || 'kiksocial',
      password: process.env.DB_PASS || '',
      database: process.env.DB_NAME || 'kiksocial_production',
